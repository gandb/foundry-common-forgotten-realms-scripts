...
3.3.3-) Implementar executeIn em ambas implemntações (chat e socketlib) (envia mensagens para usuários especificos, inicialmente bloqueado apenas pra uso de gem, posteriormente pode ser configurável)
3.3.4-) Testar casos normais (permissoes, para gm  de gm etc) na implementacao do chat
3.3.5-) Testar executeIn na implementacao socketlib
